...
function library:CreateTab(name, rainbow, color)
	...
	local tab = self:Create("ImageLabel", {
        ...
        Image = "rbxassetid://2851928757"
	})
	local top = self:Create("ImageLabel", {
		Name = "Top",
		Parent = tab,
	...
	local rainbow = self:Create("ImageLabel", {
		Parent = top,
	...
	local holder = self:Create("ImageLabel", {
		Name = "ButtonHolder",
		Parent = tab,
		BackgroundTransparency = 1,
	...
	local holder2 = self:Create("ImageLabel", {
		Name = "ButtonHolder",
		Parent = holder,
		BackgroundTransparency = 1,
	...
	local holder3 = self:Create("ImageLabel", {
		Parent = holder2,
		BackgroundColor3 = Color3.new(0.117647, 0.117647, 0.117647),
		BorderColor3 = Color3.new(0.0784314, 0.0784314, 0.0784314),
		BorderSizePixel = 3,
